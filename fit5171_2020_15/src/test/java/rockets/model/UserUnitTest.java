...
public class UserUnitTest {
    ...
    @DisplayName("should throw exception when pass a invalid email to setEmail function")
    @ParameterizedTest
    @ValueSource(strings = {"ttft675com"})
    public void shouldThrowExceptionWhenEmailIsInvalid1(String email) {
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> target.setEmail(email));
    ...
    @ParameterizedTest
    @ValueSource(strings = {"", " ", "  "})
    public void shouldThrowExceptionWhenSetPasswordToEmpty2(String password) {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"", " ", "  "})
    public void shouldThrowExceptionWhenSetLastnameToEmpty3(String lastname) {
